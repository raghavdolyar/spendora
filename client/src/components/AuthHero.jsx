...
const BalanceCard = () => (
  <div className="bg-teal-600 rounded-2xl p-5 text-white shadow-md relative overflow-hidden">
  ...
  <div className="bg-white rounded-2xl p-4 shadow-md border border-slate-100">
    ...
    <div className="grid grid-cols-2 gap-3 mb-3">
      <div>
        ...
        <div className="text-base font-bold text-teal-600">$6.3k</div>
      </div>
      <div>
  ...
  <div className="bg-white rounded-2xl p-4 shadow-md border border-slate-100">
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="space-y-1.5 flex-1 min-w-0">
        {[
          { name: "Food", value: "$320", color: "bg-teal-500" },
