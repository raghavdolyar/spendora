          ...
          <div className="w-full max-w-md">
            ...
            <form onSubmit={onSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full inline-flex items-center justify-center gap-2 bg-teal-600 active:bg-teal-800 text-white font-semibold py-4 rounded-2xl transition shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
              >
                {loading ? (
                  <>
                    <Spinner size="sm" />
