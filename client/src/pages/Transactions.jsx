          ...
          <div className="flex gap-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <button
                ...
                className="mt-3 text-xs font-medium text-teal-600 hover:text-teal-700 disabled:opacity-50"
              >
      ...
      <div className="bg-white rounded-3xl border border-slate-100 p-5">
        <div className="flex flex-col lg:flex-row lg:items-center gap-3 mb-5">
          ...
          <select
            ...
            className="px-4 py-2 rounded-full border border-slate-200 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-teal-500"
          >
